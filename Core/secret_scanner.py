...
async def scan(config):
    print(Fore.BLUE + f"[+] 🕵️ Running Secret Scanner...", flush=True)
    ...
    print(Fore.BLUE + Style.BRIGHT + f"[+] 📢 Secret Scanner found" + Fore.WHITE + Style.BRIGHT, len(secret_results), Fore.YELLOW + Style.BRIGHT + f"issues.\n", Fore.RESET)
